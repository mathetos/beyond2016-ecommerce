	...
	<div id="primary" class="content-area">
		...
		<?php if ( have_posts() ) : ?>
			...
			<?php if (class_exists('WPSEO_Meta') ) : ?>
				<?php 
					$desc = get_option('wpseo_titles'); 
					//var_dump($desc);
				?>
				<div class="entry-summary">
					<p>
						<?php echo $desc['metadesc-ptarchive-give_forms']; ?>	
					</p>
				</div>
			<?php endif; ?>
			<?php
			...
			<div id="product-archive-wrap" class="by16-section">
			...
			while ( have_posts() ) : the_post();
				 ...
				 */
				include( B16ECOM_PATH . '/integrations/give/templates/template-parts/archive-content.php');
